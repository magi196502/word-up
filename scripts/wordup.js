...
function render() {
    ...
    $("#textbox").removeClass("bad-attempt").attr("disabled",false);            // Disable the textbox
    ...
    if (disallowedLetters.length > 0) {
        ...
        $("#word-attemp-form").append(redLetterChips)
    }
...
function wordSubmissionChip(wordSubmission) {
    ...
    if (wordSubmission.hasOwnProperty("isRealWord")) {
        ...
        .addClass(wordSubmission.isRealWord?"tag-primary":"tag-danger disallowed-letter")
